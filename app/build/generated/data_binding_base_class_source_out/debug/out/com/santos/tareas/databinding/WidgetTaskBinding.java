...
public final class WidgetTaskBinding implements ViewBinding {
  ...
  @NonNull
  public static WidgetTaskBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WidgetTaskBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.widget_task, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WidgetTaskBinding bind(@NonNull View rootView) {
