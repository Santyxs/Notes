...
public final class ItemTaskRowBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemTaskRowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemTaskRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_task_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemTaskRowBinding bind(@NonNull View rootView) {
