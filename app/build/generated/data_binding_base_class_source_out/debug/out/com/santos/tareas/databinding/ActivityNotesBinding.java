...
public final class ActivityNotesBinding implements ViewBinding {
  ...
  private ActivityNotesBinding(@NonNull LinearLayout rootView, @NonNull ImageView addButton,
  ...
  public static ActivityNotesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNotesBinding((LinearLayout) rootView, addButton, emptyView, recyclerView);
    }
